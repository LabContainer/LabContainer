...
/**
 * External Student Environment :
 * Was used to connect server to another dev container where student commands are run
 * Hence student could not interfere with server process - issue with 
